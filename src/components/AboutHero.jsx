...
import aboutBg from "../assets/images/usmania/u8.jpg";

export default function AboutHero() {
  return (
    <section className="relative w-full h-[90vh] flex items-center justify-center overflow-hidden font-cursive1">
      ...
      >
        <h2 className="text-sm sm:text-lg text-[#D4AF37] tracking-widest uppercase mb-4">Usmani Decor</h2>
        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-white mb-6 leading-tight">
          Transforming Spaces into <span className="text-[#FFD700]">Luxury</span> and <span className="text-[#3CB371]">Elegance</span>
        </h1>
        <p className="text-gray-200 sm:text-lg mb-8 leading-relaxed">
          We specialize in creating premium interiors that combine <span className="font-semibold text-[#D4AF37]">style</span>, 
          <span className="font-semibold text-[#1A609F]"> comfort</span>, and 
          <span className="font-semibold text-[#239554]"> functionality</span>. 
